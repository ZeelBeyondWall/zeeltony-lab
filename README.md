...
Breaking walls, not builds.  
If it compiles, I move forward.  
Tatakae.
...
If something works and can be improved step by step, that’s good enough to move forward.
...
Beyond the wall. One commit at a time.
